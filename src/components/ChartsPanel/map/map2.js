...
// 可视化配色
//线条的汇集点坐标
var geoGpsMap = [112.206641, 31.042015];
var t = 1; //流入流出控制
var r = 1; //右侧流入流出文字控制
var geoCoordMap = {
  江苏: [118.8062, 31.9208],
...
for (var key in geoCoordMap) {
  mapData[0].push({
    year: "2020-01",
    name: key,
    value: parseInt(d1[key] / 100),
    value1: parseInt(d1[key] / 100)
  });
  mapData[1].push({
    year: "2020-02",
    name: key,
    value: parseInt(d2[key] / 100),
    value1: parseInt(d2[key] / 100)
  });
  mapData[2].push({
    year: "2020-03",
    name: key,
    value: parseInt(d3[key] / 100),
    value1: parseInt(d3[key] / 100)
  });
  mapData[3].push({
    year: "2020-04",
    name: key,
    value: parseInt(d4[key] / 100),
    value1: parseInt(d4[key] / 100)
  });
  mapData[4].push({
    year: "2020-05",
    name: key,
    value: parseInt(d5[key] / 100),
    value1: parseInt(d5[key] / 100)
  });
  mapData[5].push({
    year: "2020-06",
    name: key,
    value: parseInt(d6[key] / 100),
    value1: parseInt(d6[key] / 100)
  });
}
