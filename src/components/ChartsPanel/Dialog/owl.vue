  ...
  >
    <q-card-section style="font-size:1.8rem">
      <div class="flex" style="margin:0.8rem;justify-content: space-around;">
        <label for="今日销售数">设备名称</label>
        <span class="num">主街001</span>
        <label for="本月销售数">设备安装地址</label
        ><span class="num">中天街22号雅思门口</span>
      </div>
    </q-card-section>
    <q-card-section style="font-size:1.8rem">
    ...
    <q-card-section style="font-size:1.8rem">
      <label for="销售情况">监测情况</label>
      <div class="flex" style="margin:0.8rem;justify-content: space-around;">
        <label for="今日销售数">总监测人数</label>
        <span class="num">265330</span>
        <label for="本月销售数">总异常人数</label><span class="num">93</span>
      </div>
      <div
        class="flex"
        style="margin-left:0.8rem;justify-content: space-around;"
      >
        <label for="今日销售额">今日监测人数</label
        ><span class="num">1672</span>
        <label for="本月销售额">今日异常人数</label><span class="num">0</span>
      </div>
    </q-card-section>
    <q-card-section style="font-size:1.8rem">
      ...
      <label for="name">检测人数趋势</label>
      <div style="height:20rem;" id="sxqk"></div>
    </q-card-section>
    <q-card-section style="font-size:1.8rem">
      <label for="name">异常人数趋势</label>
      <div style="height:20rem;" id="ycrs"></div>
    </q-card-section>
  </DialogDraggable>
</template>
...
export default {
  ...
  methods: {
    ...
    drawLine2() {
      ...
      var chartDom = document.getElementById("ycrs");
      var myChart = echarts.init(chartDom);
      myChart.setOption(option);
    },
    close() {
